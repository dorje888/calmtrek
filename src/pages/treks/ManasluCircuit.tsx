                ...
                <div className="space-y-8" aria-label="Manaslu Circuit daily itinerary">
                  ...
                  <details className="group rounded-xl border border-border/60 bg-white/70 overflow-hidden">
                    ...
                    <div className="px-5 pb-5">
                      <div className="relative">
                        <div className="absolute left-5 top-0 bottom-0 w-0.5 bg-border" aria-hidden="true"></div>
                        <div className="space-y-8" aria-label="Manaslu Circuit daily itinerary (expanded)">
                          <div className="relative pl-14"><div className="absolute left-0 top-1 w-10 h-10 rounded-full bg-mountain-100 flex items-center justify-center z-10"><span className="font-bold text-mountain-700">3</span></div><h4 className="font-bold text-lg mb-1 text-foreground">Machha Khola → Jagat</h4><p className="text-muted-foreground">1,340 m — Enter the restricted area gateway.</p></div>
                          <div className="relative pl-14"><div className="absolute left-0 top-1 w-10 h-10 rounded-full bg-mountain-100 flex items-center justify-center z-10"><span className="font-bold text-mountain-700">4</span></div><h4 className="font-bold text-lg mb-1 text-foreground">Jagat → Deng</h4><p className="text-muted-foreground">1,860 m — Cliffs, waterfalls, and river gorges.</p></div>
                          <div className="relative pl-14"><div className="absolute left-0 top-1 w-10 h-10 rounded-full bg-mountain-100 flex items-center justify-center z-10"><span className="font-bold text-mountain-700">5</span></div><h4 className="font-bold text-lg mb-1 text-foreground">Deng → Namrung</h4><p className="text-muted-foreground">2,630 m — Forested climbs toward alpine zones.</p></div>
                          <div className="relative pl-14"><div className="absolute left-0 top-1 w-10 h-10 rounded-full bg-mountain-100 flex items-center justify-center z-10"><span className="font-bold text-mountain-700">6</span></div><h4 className="font-bold text-lg mb-1 text-foreground">Namrung → Lho</h4><p className="text-muted-foreground">3,180 m — First broad views of Manaslu massif.</p></div>
                          <div className="relative pl-14"><div className="absolute left-0 top-1 w-10 h-10 rounded-full bg-mountain-100 flex items-center justify-center z-10"><span className="font-bold text-mountain-700">7</span></div><h4 className="font-bold text-lg mb-1 text-foreground">Lho → Samagaon</h4><p className="text-muted-foreground">3,530 m — Monasteries and Tibetan-influenced settlements.</p></div>
                          <div className="relative pl-14"><div className="absolute left-0 top-1 w-10 h-10 rounded-full bg-mountain-100 flex items-center justify-center z-10"><span className="font-bold text-mountain-700">8</span></div><h4 className="font-bold text-lg mb-1 text-foreground">Acclimatization in Samagaon</h4><p className="text-muted-foreground">Side trip to Manaslu Base Camp or Pungyen Gompa.</p></div>
                          <div className="relative pl-14"><div className="absolute left-0 top-1 w-10 h-10 rounded-full bg-mountain-100 flex items-center justify-center z-10"><span className="font-bold text-mountain-700">9</span></div><h4 className="font-bold text-lg mb-1 text-foreground">Samagaon → Samdo</h4><p className="text-muted-foreground">3,875 m — Windswept valley and yak pastures.</p></div>
                          <div className="relative pl-14"><div className="absolute left-0 top-1 w-10 h-10 rounded-full bg-mountain-100 flex items-center justify-center z-10"><span className="font-bold text-mountain-700">10</span></div><h4 className="font-bold text-lg mb-1 text-foreground">Samdo → Dharmasala</h4><p className="text-muted-foreground">4,460 m — Prepare for the pass; early night.</p></div>
                          <div className="relative pl-14"><div className="absolute left-0 top-1 w-10 h-10 rounded-full bg-mountain-100 flex items-center justify-center z-10"><span className="font-bold text-mountain-700">11</span></div><h4 className="font-bold text-lg mb-1 text-foreground">Cross Larkya La → Bimtang</h4><p className="text-muted-foreground">5,160 m / 3,720 m — Big day with sweeping Himalayan panoramas.</p></div>
                          <div className="relative pl-14"><div className="absolute left-0 top-1 w-10 h-10 rounded-full bg-mountain-100 flex items-center justify-center z-10"><span className="font-bold text-mountain-700">12</span></div><h4 className="font-bold text-lg mb-1 text-foreground">Bimtang → Tilije</h4><p className="text-muted-foreground">2,300 m — Descend through rhododendron forests.</p></div>
                          <div className="relative pl-14"><div className="absolute left-0 top-1 w-10 h-10 rounded-full bg-mountain-100 flex items-center justify-center z-10"><span className="font-bold text-mountain-700">13</span></div><h4 className="font-bold text-lg mb-1 text-foreground">Tilije → Dharapani, drive to Besisahar</h4><p className="text-muted-foreground">1,960 m — Exit onto Annapurna Circuit road-head.</p></div>
                          <div className="relative pl-14"><div className="absolute left-0 top-1 w-10 h-10 rounded-full bg-mountain-100 flex items-center justify-center z-10"><span className="font-bold text-mountain-700">14</span></div><h4 className="font-bold text-lg mb-1 text-foreground">Drive Besisahar → Kathmandu</h4><p className="text-muted-foreground">Return to Kathmandu; trek concludes.</p></div>
                        </div>
                      </div>
                    </div>
                  </details>
